 ...
 *
 *      History mode is passed through to ERC721H constructor.
 *
    ...
    function deployCollection(
        ...
        collection = address(
            new ERC721HCollection{salt: effectiveSalt}(
                name_, symbol_, maxSupply_, baseURI_, mode_
            )
        );
        ...
        emit CollectionDeployed(
            collection, msg.sender, name_, symbol_, maxSupply_, salt, mode_
        );
    }
    ...
    function predictAddress(
        ...
        bytes32 codeHash = keccak256(
            abi.encodePacked(
                ...
                abi.encode(name_, symbol_, maxSupply_, baseURI_, mode_)
            )
        );
